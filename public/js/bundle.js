...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZnJhbmt6YXBwYXRvIiwiYSI6ImNsbWF1MGlibzBybXkzaHM1dno0YjM4c2gifQ.tsTb9gPPFYOM1qA1o1G-Lw';
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51NuzDvBWaoEoFrBymH0WjqV4XkIZ9bHla26sbpmCx9PXV0LPajDzcu3VSqjF4Nymlgn1FP8JTFOW7hPdFl81zJSr00szjurYNf');
          _context.prev = 1;
          _context.next = 4;
...
var loginBtnForm = document.querySelector('.btn--login');
...
if (loginBtnForm) {
  loginBtnForm.addEventListener('click', function (e) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            passwordConfirm = document.getElementById('password-confirm').value; // const name = document.getElementById('name').value;
            _context.next = 8;
